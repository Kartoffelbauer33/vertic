...
CREATE TABLE "app_users" (
    ...
    "preferredHallId" bigint,
    "lastKnownHallId" bigint,
    "registrationHallId" bigint,
    "profilePhoto" bytea,
...
--
-- Class Country as table countries
--
...
--
-- Class ExternalCheckinLog as table external_checkin_logs
--
...
--
-- Class ExternalProvider as table external_providers
--
CREATE TABLE "external_providers" (
    ...
    "isActive" boolean NOT NULL DEFAULT true,
    "apiBaseUrl" text,
    "apiCredentialsJson" text,
    "sportPartnerId" text,
    "doorId" text,
    "allowReEntry" boolean NOT NULL DEFAULT true,
    "reEntryWindowType" text NOT NULL DEFAULT 'hours'::text,
    "reEntryWindowHours" bigint NOT NULL DEFAULT 3,
    "reEntryWindowDays" bigint NOT NULL DEFAULT 1,
...
CREATE TABLE "facilities" (
    ...
    "contactPhone" text,
    "countryId" bigint,
    "isCountryLocked" boolean NOT NULL DEFAULT false,
    "isActive" boolean NOT NULL,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone,
    "countryAssignedByStaffId" bigint,
    "countryAssignedAt" timestamp without time zone
);
...
--
-- Class OpenFoodFactsCache as table open_food_facts_cache
--
...
--
-- Class PendingStaffUser as table pending_staff_users
--
...
--
-- Class PosCartItem as table pos_cart_items
--
...
--
-- Class PosSession as table pos_sessions
--
...
--
-- Class PosTransaction as table pos_transactions
--
...
CREATE TABLE "product_categories" (
    ...
    "iconName" text NOT NULL DEFAULT 'category'::text,
...
CREATE TABLE "products" (
    ...
    "isActive" boolean NOT NULL DEFAULT true,
    "isFoodItem" boolean NOT NULL DEFAULT false,
    "taxClassId" bigint,
    "defaultCountryId" bigint,
    ...
    "isSubjectToSpecialTax" boolean NOT NULL DEFAULT false,
...
--
-- Class StaffVerificationToken as table staff_verification_tokens
--
...
--
-- Class TaxClass as table tax_classes
--
...
--
-- Class UserExternalMembership as table user_external_memberships
--
