...
CREATE TABLE "app_users" (
    ...
    "isFacilityAdmin" boolean NOT NULL DEFAULT false,
...
--
-- Class StaffPermission as table staff_permissions
--
...
--
-- Class StaffRolePermission as table staff_role_permissions
--
...
--
-- Class StaffRole as table staff_roles
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('test_server', '20250609180015616', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250609180015616', "timestamp" = now();
